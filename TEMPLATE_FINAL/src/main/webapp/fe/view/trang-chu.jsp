         ...
         <div class="container">
             <form action="/khach-hang/add" method="post">
                <div class="row mt-2">
                        <div class="row mt-2">
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input id="ma" type="text" class="form-control" name="ma" value="${KH.ma}">
                                </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-3" >
                                <button type="submit" class="btn btn-success btn-rounded btn-block" style="width: 100px;height: 40px" onclick="check()"  >ADD</button>
                            </div>
                        </div>
                </div>
             </form>
             <div class="row mt-2">
                 <div class="col-3" >
                     <a href="/khach-hang/hienthi"  class="btn btn-warning btn-rounded btn-block" style="width: 100px;height: 40px" >Hiển Thị</a>
                 </div>
             </div>
                 ...
                 <c:forEach items="${ListKH}" var="kh" varStatus="i">
                     <tr>
                         ...
                         <td style="text-align: center">
                             <a class="btn btn-secondary" href="/khach-hang/detail?ma=${kh.ma}">Detail</a>
                             <a class="btn btn-primary" href="/khach-hang/viewUpdate?ma=${kh.ma}">Update</a>
                             <a class="btn btn-danger" href="/khach-hang/delete?ma=${kh.ma}" onclick="checkDel()">Delete</a>
                         </td>
                     </tr>
                 </c:forEach>
                 </tbody>
